           ...
           <tr>
             <td align="center" valign="top" style="padding: 36px 24px;">
               <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                 <img src="https://www.nike.com/favicon.ico?v=1" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
               </a>
             </td>
           </tr>
         </table>
                 ...
                 <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                   <tr>
                     <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                       ...
                       <p>${order.selectedAddress[0].name}<br>${
    order.selectedAddress[0].street
  }<br>${order.selectedAddress.city},${order.selectedAddress[0].state},${
    order.selectedAddress[0].pinCode
  }</p>
                       <p>${order.selectedAddress[0].phoneNumber}</p>
